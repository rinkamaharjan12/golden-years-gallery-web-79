...
const Events = () => {
  ...
  return <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {upcomingEvents.map(event => <Card key={event.id} className="hover:shadow-lg transition-shadow duration-300 flex flex-col h-full">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">Current Discussions</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {currentIssues.map((issue, index) => <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
